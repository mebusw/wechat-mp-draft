...
1. 你会调用SKILL `/jackyshen-write-wechat-article`来编写优秀的公众号文章 
2. 你会调用SKILL `/wechat-markdown-html-render` 来分别渲染文本和代码样式。
3. 调用任何可用的文生图SKILL来配1张封面图和2张插图（ar 2.35:1）
4. 调用本SKILL来访问微信公众号文章草稿箱
